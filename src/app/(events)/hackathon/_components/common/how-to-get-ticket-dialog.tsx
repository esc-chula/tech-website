    ...
    <Dialog modal>
      ...
      <DialogContent className='w-4/5 rounded-2xl border-2 border-white/40 bg-white/10 px-4 py-4 backdrop-blur-md sm:w-full md:px-10 md:py-8'>
        ...
        <ol className='flex list-decimal flex-col gap-2 text-xs leading-relaxed text-white/80 sm:text-base'>
          <li>
            <span className='font-bold'>Form Your Team:</span> Team up with 4-5
          ...
          <li>
            ...
            hints and Easter eggs on our social media & LINE OpenChat to locate
            your two Ticket Codes.
          </li>
          <li>
            <span className='font-bold'>Register Your Ticket:</span> Each Ticket
            Code must be claimed at Register page.
            <br />
            <br />
            <span className='font-medium'>Note:</span> There are 4 types of
            ticket, which are General, Developer, Designer, and Product. Both of
            your claimed tickets must be a different type to be able to merge
            them into a Team Pass.
            <br />
            <br />
            <span className='font-medium'>Note:</span> When you claim a ticket,
            you have around 48 hours to find another ticket before the ticket
            expires, allowing others that have the same code to claim your
            ticket too
          </li>
          <li>
