/* eslint-disable -- Three.js code is not compatible with eslint */
// @ts-nocheck
...
useTexture.preload(TEXTURE_FILE);

interface TicketBandProps {
  pausedPhysics?: boolean;
}

const TicketBand: React.FC<TicketBandProps> = ({ pausedPhysics }) => {
  return (
...
export default TicketBand;

function Band({ maxSpeed = 50, minSpeed = 10, initialPosition = [2, 0, 0] }) {
